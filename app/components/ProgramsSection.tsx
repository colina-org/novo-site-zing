      ...
      <div className="container">
        ...
        >
          {programs.slice(0, 4).map((program, i) => (
            ...
            >
              <div className="flex h-full flex-col justify-between gap-4 overflow-hidden rounded bg-white p-2 shadow-[0px_0px_1px_0px_rgba(38,43,47,0.04),0px_4px_10px_0px_rgba(38,43,47,0.07)]">
                {/* Image */}

                <div className="h-full max-h-fit mb-4">
                  <div className="relative h-13.5 overflow-hidden mb-4">
                    <Image
                      src={program.image}
                      alt={program.title}
                      fill

...
export default function HeroDesafiosIntra() {
  return (
    <section className="bg-white py-20 max-sm:py-10">
      <div className="container">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          {/* Text content */}
          <div className="flex max-w-3xl flex-col gap-13.5">
            <div className="flex flex-col gap-6">
              <h1 className="text-5xl max-sm:text-3xl font-normal leading-tight text-black">
                <span className="font-medium">Inovação</span> de nasce de dentro
              </h1>
              <p className="text-lg font-normal leading-relaxed text-black">
                Programas de intraempreendedorismo que transformam a experiência
                dos colaboradores em ideias estruturadas, avaliadas e
                acompanhadas em um único ambiente.
              </p>
            </div>

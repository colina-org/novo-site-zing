...
export default function HeroProgramaInovacaoAberta() {
  return (
          ...
          <div className="flex max-w-2xl flex-col gap-13.5">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg font-normal leading-relaxed text-black">
                Da definição do desafio à validação da solução, a Zing apoia
                todo o ciclo de inovação com governança, rastreabilidade e foco
                em valor concreto.
              </p>
            </div>
